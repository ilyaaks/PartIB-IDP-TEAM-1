...
class Path:
    ...
    def _path_G_to_A0(current_position, desired_position):
        ...
        return ["straight", "left_forward","right_forward", "stop"], [0, 2, 2, int(desired_position[2])] #sequence of turns and number of lines at which to detect it
    ...
    def _path_A0_to_G(current_position, desired_position):
        ...
        return ["straight", "left_straight", "right_straight", "stop"], [0, int(current_position[2]), 2, 0] #sequence of turns and number of lines at which to detect it
